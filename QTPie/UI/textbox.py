...
class QTPieTextbox(PyQt5.QtWidgets.QLineEdit):
    """
    ...
    def dragEnterEvent(self, event):
        ...
        Returns:\n
            PyQt5.QtWidgets.QLineEdit.dragEnterEvent: Runs the parents dragEnterEvent.
        """
        ...
        return super(QTPieTextbox, self).dragEnterEvent(event)
    ...
    def dropEvent(self, event):
        ...
        Returns:\n
            PyQt5.QtWidgets.QLineEdit.dropEvent: Runs the parents dropEvent.
        """

        return super(QTPieTextbox, self).dropEvent(event)
